...
export function UserFormDialog({
  ...
  const fields: ReadonlyArray<{
    name:
      "firstName" | "lastName" | "email" | "password" | "indicatif" | "phone"
    label: string
  ...
  return (
    <Dialog
      open={open}
      onOpenChange={(next) => (next ? onOpenChange(true) : !pending && close())}
    >
      <DialogContent className="sm:max-w-xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Renseignez son identité, son rôle et son niveau d’accès.
          </DialogDescription>
        </DialogHeader>
        <form
          className="contents"
